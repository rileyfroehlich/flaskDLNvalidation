...
class dlnvForm(FlaskForm):
    ...
    dlMonth = StringField('What month does your Drivers License Expire? (i.e. January)', validators=[DataRequired(), Length(min=1)])
    dlYear = StringField('What year does your Drivers License Expire? (i.e. 1978)', validators=[DataRequired(), Length(min=1)])
