def Idaho_is_valid(dln, DOB, expiration_date, eyes, hair, height, issue_date, sex, weight, extra=None):
    from Generic_State import generic_State_is_valid
    expiration_length = [8, 4]
    sex_X = False
    hair = hair
...
if ( __name__ == "__main__" ):
    print(Idaho_is_valid("123456789", "01-01-2000", "02-04-2028", "BRO", "BRO", '5-11', "02-04-2020",'M', '160'))
